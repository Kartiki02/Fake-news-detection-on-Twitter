    ...
    <body>
                    ...
                    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                        <nav class="menu--iris">
                            <ul class="nav navbar-nav menu__list">
                                ...
                                <li class="menu__item menu__item--current"><a href="AdminViewTweetStatus.jsp" class="menu__link">Tweet Status</a></li>
        ...
        <div class="blog" id="blog">
            <div class="container">
                ...
                <h3 class="w3l_header w3_agileits_header"> View  <span>  Negative Tweet's</span></h3>
                <div class="agile_inner_w3ls-grids">
                    <center>
                        <%
                            ...
                            PreparedStatement ps = cn.prepareStatement("select * from negative");
                            ResultSet rs = ps.executeQuery();

                        %>

                        <table border="3" width="90%" class="table-success" cellpadding="3" align="center">
                            <b>
                                <tbody align="center">
                                <td><b>ID &nbsp;&nbsp;&nbsp;&nbsp;</b></td>
                                <td><b>User Name &nbsp;&nbsp;&nbsp;&nbsp;</b></td>
                                ...
                                <tr align="">
                                    ...
                                    <td><b><%out.println(rs.getString("user"));%>&nbsp;&nbsp;</b></td>
                                    <td><b><%out.println(rs.getString("tweet"));%>&nbsp;&nbsp;</b></td>
                                    <td><b><%out.println(rs.getString("tdate"));%>&nbsp;&nbsp;</b></td>
                                </tr>
        ...
        <div class="blog" id="blog">
            <div class="container">
                ...
                <h3 class="w3l_header w3_agileits_header"> View  <span>  Positive Tweet's</span></h3>
                <div class="agile_inner_w3ls-grids">
                    <center>
                        <%
                            PreparedStatement ps1 = cn.prepareStatement("select * from positive");
                        ...
                        <table border="3" width="90%" class="table-success" cellpadding="3">
                            <b><tbody align="center">
                                ...
                                %>
                                <tr align="">
                                    <td><%out.println(rs1.getString("id"));%>&nbsp;&nbsp;</td>
                                    <td><%out.println(rs1.getString("user"));%>&nbsp;&nbsp;</td>
                                    <td><%out.println(rs1.getString("tweet"));%>&nbsp;&nbsp;</td>
                                    <td><%out.println(rs1.getString("tdate"));%>&nbsp;&nbsp;</td>
                                </tr>
                                <%
                                    }
                                %>
        ...
        <div class="blog" id="blog">
            <div class="container">
                ...
                <h3 class="w3l_header w3_agileits_header"> View  <span>  Rumor's</span></h3>
                <div class="agile_inner_w3ls-grids">
                    <center>
                        <%
                            PreparedStatement ps2 = cn.prepareStatement("select * from rumour");
                        ...
                        <table border="3" width="90%" class="table-success" cellpadding="3">
                            <b><tbody align="center">
                                ...
                                %>
                                <tr align="">
                                    <td><%out.println(rs2.getString("id"));%>&nbsp;&nbsp;</td>
                                    <td><%out.println(rs2.getString("user"));%>&nbsp;&nbsp;</td>
                                    <td><%out.println(rs2.getString("tweet"));%>&nbsp;&nbsp;</td>
                                    <td><%out.println(rs2.getString("tdate"));%>&nbsp;&nbsp;</td>
                                </tr>
                                <%
                                    }
                                %>

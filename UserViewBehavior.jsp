...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                        <nav class="menu--iris">
                            <ul class="nav navbar-nav menu__list">
                                ...
                                <li class="menu__item"><a href="UserViewTweet.jsp" class="menu__link">View Tweet's</a></li>
        ...
        <div class="blog" id="blog">
            ...
            <center><div id="chartContainer" style="width: 45%; height: 300px;display: inline-block;"></div><br><br> 
                    <div id="chartContainer1" style="width: 45%; height: 300px;display: inline-block;"></div><br/><br>

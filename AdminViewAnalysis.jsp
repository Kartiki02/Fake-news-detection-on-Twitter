    ...
    <body>
                    ...
                    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                        <nav class="menu--iris">
                            <ul class="nav navbar-nav menu__list">
                                ...
                                <li class="menu__item menu__item--current"><a href="AdminViewAnalysis.jsp" class="menu__link">View Analysis</a></li>
        ...
        <div class="blog" id="blog">
            <div class="container">
                ...
                <h3 class="w3l_header w3_agileits_header"> View <span>  Analysis</span></h3>
                        ...
                        <p>
                            <%
                                try {
                                    ...
                                    PreparedStatement ps = cn.prepareStatement("select * from viewanalysis ORDER BY ID DESC LIMIT 1");
                            ...
                            <b><tbody align="center">
                                ...
                                <tbody style="color:black">
                                    ...
                                    <tr>
                                        ...
                                        <td><%out.println(rs.getString("positive"));%></td>
                                        <td><%out.println(rs.getString("negative"));%></td>
                                        <td><%out.println(rs.getString("rumor"));%></td>

...
<html lang="en">
                    ...
                    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                        <nav class="menu--iris">
                            <ul class="nav navbar-nav menu__list">
                                <li class="menu__item"><a href="UserHome.jsp" class="menu__link">Home</a></li>
                                <li class="menu__item menu__item--current"><a href="UserViewTweet.jsp" class="menu__link">View Tweet's</a></li>
                                <li><a class="active" href="#" data-toggle="modal" data-target="#myModal8"><i class="fa fa-sign-in" aria-hidden="true"></i>Search Tweet's</a></li>
                    ...
                    <div class="modal-header">
                        ...
                        <div class="signin-form profile">
                            ...
                            <div class="login-form">
                                <form action="UserSearchTweet.jsp"  autocomplete="off">
    ...
    <center> <b>  <p>© 2020 Fake News Detection Project. All Rights Reserved. <a href="https://.com/" target="_blank"></a></p></center>
                                            </b>
    <!-- //footer -->

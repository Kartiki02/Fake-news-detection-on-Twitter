...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div class="signin-form profile">
                                    <h3 class="agileinfo_sign">Submit OTP</h3>	
                                    <div class="login-form">
                                        <form action="CheckOTP" method="post">
                                            <input type="text" name="otp" placeholder="Submit Your OTP Here..." required="">
                                            <div class="tp">
        ...
        <!-- //bootstrap-pop-up -->
        <!-- banner-bottom -->
        <h3 class="w3l_header w3_agileits_header">WELCOME <span></span></h3>
